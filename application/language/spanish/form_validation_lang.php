...
$lang['is_unique'] 	    	= "El campo %s ya esta registrado favor de revisar la información.";
$lang['is_natural']         = "El campo %s debe contener sólo números.";
// frase original $lang['is_natural']         = "El campo %s debe contener sólo números positivos.";
$lang['is_natural_no_zero'] = "El campo %s debe contener un número mayor que cero.";
$lang['decimal']	    = "El campo %s must contain a decimal number.";
$lang['less_than']	    = "El campo %s debe ser un número menor a %s.";
$lang['greater_than']	    = "El campo %s debe ser un número mayor a %s.";
$lang['valida_url']          = "El campo %s debe contener una dirección electrónica (URL) válida.";
