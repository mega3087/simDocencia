					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<?php
									echo form_open_multipart("archivo_csv/index/$nombre_campo", 'id="upload" class="upload"');
									
									echo '<label title="Subir archivo" for="userfile" class="btn btn-primary">
									<input type="file" accept="application/csv" name="userfile" id="userfile" class="hide">
									Seleccionar archivo
									</label>';
									echo '<label><input class="disabled" disabled id="archivo_nombre" size="38%"></label>'. br('2');
									
									echo "<input type='submit' class='button btn btn-primary' id='submit' value='Subir archivo'>" . nbs(5);
									...
									echo '<em>Sólo se permiten archivos CSV <i class="fa fa-file-pdf-o"></i> con tamaño máximo de 2MB.</em>';
									echo form_close();
								?>		
							</div>
						</div>
