				...
				<div class="form-group ">
					...
					<div class="col-lg-9">
						...
						<div class="row">
							...
							<div class="col-lg-4">
								<select name="AAnio" id="AAnio" class="form-control required">
							...
							<div class="col-lg-4">
								<select name="AMes" id="AMes" class="form-control required">
							...
							<div class="col-lg-4">
								<select name="AQuincena" id="AQuincena" class="form-control" required>
